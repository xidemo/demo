...
class AdminCest
{
    ...
    public function CategoryCRUD(AdminTester $I)
    {
        ...
        $I->fillField($I->getInputFieldByPlaceholder('Enter the new category name'), 'Shiny Cat');
        ...
        $I->canSeeInField($I->getInputFieldByPlaceholder('Enter the new category name'), 'Shiny Cat');
        $I->fillField($I->getInputFieldByPlaceholder('Enter the new category name'), 'Shiny Dog');
